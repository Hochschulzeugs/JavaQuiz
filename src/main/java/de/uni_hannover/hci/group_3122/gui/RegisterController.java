	...
	private void buttonHandleRegister(ActionEvent event){
		...
		try{
            ...
            if (dataBase.createUser(userName, password)) {
                alert.setContentText("Benutzer " + userName + " erfolgreich erstellt!");
                alert.showAndWait();
            ...
            alert.setContentText("Registrierung fehlgeschlagen: Der Benutzer " + getUserName() + " existiert bereits oder es besteht keine Internetverbindung!");
